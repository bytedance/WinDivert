...
#define WINDIVERT_UNOFFICIAL_PROVIDER_GUID
#define WINDIVERT_UNOFFICIAL_BUNDLED_RESOURCE // Pack the driver sys into resource file
#define WINDIVERT_UNOFFICIAL_DRIVER_FILE_NAME // Use the driver sys in resource file
#endif

#ifdef WINDIVERT_UNOFFICIAL_DRIVER_FILE_NAME
#define WINDIVERT_UNOFFICIAL_BUNDLED_RESOURCE
#define WINDIVERT_UNOFFICIAL_SERVICE_NAME
#endif
